...
function Events() {
  return (
    <>
      ...
      />
      <Event
        img="./assets/Logos/startupvit.png"
        fit="fit"
        name="Start-up VIT"
      ...
      />
      <Event
        img="./assets/Logos/alumni_talk.png"
        fit="fit"
        name="Alumni Talk"
